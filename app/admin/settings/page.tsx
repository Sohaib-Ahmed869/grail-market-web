 ...
 *
 * It used to be a section inside a five-tab Settings page, and before that it
 * was its own route at /admin/profile. That old Settings page held the rules
 * the marketplace runs on for everybody — review thresholds, policy — and
 * those moved out to their own pages in the sidebar (and Team & access moved
 * to Manage access, off the Admin Team page). What is left here is what was
 * always this page's own job: one person's name and one person's password,
 * applying to nobody else. It took the Settings name and the /admin/settings
 * address because that name was free once the marketplace-wide page moved
 * out, and it is where the account menu already sends people who are looking
 * for "settings".
 *
...
function SettingsPage() {
  ...
  return (
    <>
      <PageHead title="Settings" sub="Your own account. Nobody else's." />
